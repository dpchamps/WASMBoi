...
impl From<&CartridgeType> for MBC {
    fn from(cart_type: &CartridgeType) -> Self {
        match cart_type {
            ...
            CartridgeType::MBC1 | CartridgeType::MBC1_RAM | CartridgeType::MBC1_RAM_BAT => MBC::Mbc1,
            CartridgeType::MBC2 | CartridgeType::MBC2_BAT => MBC::Mbc2,
            CartridgeType::MMM_01 | CartridgeType::MMM_01_RAM | CartridgeType::MMM_01_RAM_BAT => MBC::Mmm,
            CartridgeType::MBC3 | CartridgeType::MBC3_TIMER_BAT | CartridgeType::MBC3_RAM_TIMER_BAT | CartridgeType::MBC3_RAM | CartridgeType::MBC3_RAM_BAT  => MBC::Mbc3,
            CartridgeType::MBC4 | CartridgeType::MBC4_RAM | CartridgeType::MBC4_RAM_BAT => MBC::Mbc4,
            CartridgeType::MBC5 | CartridgeType::MBC5_RAM |  CartridgeType::MBC5_RAM_BAT => MBC::Mbc5,
        }
    }
}
